...
void SimpleShapeApplication::init() {
    ...
    std::vector<GLfloat> vertices = {
        -0.5f, -0.25f, 0.0f,  // Bottom left corner of the square
         0.5f, -0.25f, 0.0f,  // Bottom right corner of the square
         0.5f,  0.25f, 0.0f,  // Top right corner of the square
        -0.5f,  0.25f, 0.0f,  // Top left corner of the square
         0.0f,  0.75f, 0.0f   // Top of the roof
    };
